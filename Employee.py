...
class employeeClass:
    def __init__(self,root):
        ...
        #search frame
        SearchFrame=LabelFrame(self.root,text="Search Employee",font=("Arial",15,"bold"),bd=2,relief=RIDGE,bg="white")
        SearchFrame.place(x=250,y=20,width=600,height=70)

        #options
        cmb_search=ttk.Combobox(SearchFrame,textvariable=self.var_searchby,values=("Select","Name","Email","Contact"),state='readonly',justify=CENTER,font=("goudy old style",12))
        cmb_search.place(x=8,y=9,width=180)
        cmb_search.current(0)

        txt_search=Entry(SearchFrame,textvariable=self.var_searchtxt,font=("goudy old style",12),bg="lightyellow").place(x=220,y=10)
        btn_search=Button(SearchFrame,text="Search",command=self.search,font=("goudy old style",12),bg="#4caf50",fg="white",cursor='hand2').place(x=410,y=8,width=150,height=25)
        ...
        lbl_dob=Label(self.root,text="DOB",font=("Goudy old style",15),bg="white").place(x=400,y=190)
       ...
       #ROW3
        ...
        txt_salary=Entry(self.root,textvariable=self.var_salary,font=("Goudy old style",15),bg="lightyellow").place(x=550,y=272,width=180)


    #Buttons
        btn_add=Button(self.root,text="Save",command=self.add,font=("goudy old style",12),bg="#2196f3",fg="white",cursor='hand2').place(x=570,y=315,width=110,height=25)
        btn_update=Button(self.root,text="Update",command=self.update,font=("goudy old style",12),bg="#4caf50",fg="white",cursor='hand2').place(x=690,y=315,width=110,height=25)
        btn_delete=Button(self.root,text="Delete",command=self.delete,font=("goudy old style",12),bg="#f44336",fg="white",cursor='hand2').place(x=810,y=315,width=110,height=25)
        btn_clear=Button(self.root,text="Clear",command=self.clear,font=("goudy old style",12),bg="#607d8b",fg="white",cursor='hand2').place(x=930,y=315,width=110,height=25)
    ...
    def add(self):
        ...
        try:
            if self.var_emp_id.get()=="":
                ...
                row=cur.fetchone()
                if row!=None:
                    messagebox.showerror("Error","This ID is already Defined",parent=self.root)
                else:
