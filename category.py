...
#Title
        ...
        cat_frame.place(x=700,y=100,width=300,height=350)    
       ...
       #images
        # self.im1=Image.open("Images/ct.jpg")
        # self.im1=self.im1.resize((500,250),Image.ANTIALIAS)
        # self.im1=ImageTk.PhotoImage(self.im1)

        # self.lbl_im1=Label(self.root,image=self.im1,bd=2,relief=RAISED)
        # self.lbl_im1.place(x=35,y=220)
        
        # self.im2=Image.open("Images/ct2.jpeg")
    ...
    def add(self):
        ...
        try:
            if self.var_name.get()=="":
                ...
                row=cur.fetchone()
                if row!=None:
                    messagebox.showerror("Error","Category is already Available",parent=self.root)
                else:
